...
void  orbit_idl_output_c_skelimpl  (IDL_tree       tree,
				    OIDL_Run_Info *rinfo,
				    OIDL_C_Info   *ci);
void  orbit_idl_output_h_skelimpl  (IDL_tree       tree,
				    OIDL_Run_Info *rinfo,
				    OIDL_C_Info   *ci);
...
char    *orbit_cbe_get_typespec_str2     (IDL_tree    tree, OIDL_TypeNameType tn);
char *orbit_cbe_write_param_typespec_str3(IDL_tree ts, IDL_ParamRole role, OIDL_TypeNameType otype);
void     orbit_cbe_write_typespec       (FILE       *of,
					 IDL_tree    tree);
void     orbit_cbe_write_param_typespec (FILE       *of,
					 IDL_tree    tree);
void     orbit_cbe_write_param_typespec3 (FILE       *of,
					 IDL_tree    tree,
